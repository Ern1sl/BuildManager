              ...
              <Form className="space-y-6">
                ...
                <div>
                  ...
                  <Field
                    name="email"
                    type="email"
                    className={`w-full bg-[#0d0d0d] border rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none transition-all ${touched.email && errors.email ? 'border-red-500/50' : 'border-white/10 focus:ring-2 focus:ring-blue-500/50'}`}
                ...
                <div>
                  ...
                  <div className="relative group/pass">
                    <Field
                      ...
                      className={`w-full bg-[#0d0d0d] border rounded-xl px-4 py-3 pr-12 text-white placeholder-gray-500 focus:outline-none transition-all group-hover/pass:border-white/20 ${touched.password && errors.password ? 'border-red-500/50' : 'border-white/10 focus:ring-2 focus:ring-blue-500/50'}`}
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                >
                  <span className={isSubmitting ? "opacity-0" : "opacity-100"}>Sign In</span>
                  {isSubmitting && (
