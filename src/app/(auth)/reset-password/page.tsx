    ...
    return (
      <div className="text-center space-y-6">
        ...
        <p className="text-sm text-gray-400">
          The recovery link is missing or invalid.
        </p>
        <Link
  ...
  if (status?.type === "success") {
    return (
      <div className="text-center space-y-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-green-500 tracking-tight">
            Password Reset Achieved
          </h2>
          <p className="text-sm text-gray-400 mt-2">
            Your system password has been synchronized successfully.
          </p>
        </div>
        <Link
          href="/login"
          ...
          <Form className="space-y-6">
            ...
            <div>
              ...
              <FormError
                ...
                message={errors.newPassword as string}
              />
            </div>
